...
create table public.diary_entries (
  ...
  practice_generation_status text not null default 'processing'
    check (practice_generation_status in ('processing', 'completed', 'failed')),
...
create index translation_cards_diary_idx
on public.translation_cards (diary_entry_id, sort_order);
